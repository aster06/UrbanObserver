...
import { sizeOptions, colorOptions, textColorOptions } from './buttonconfig';
...
export default class ButtonEditing extends Plugin {
  ...
  _defineConverters() {
    ...
    conversion.attributeToAttribute(buildAttributeToAttributeDefinition('linkButtonText', textColorOptions));
